...
class GeneralRBFSolverGrad:
    ...
    def sample_by_target_matching(self, x, target, steps, skip_type='logSNR', order=3, log_scale_max=6.0, optim_lr=1e-1, optim_steps=100):
        print('sample_by_target_matching_grad!!!!!')
