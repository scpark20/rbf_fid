...
class RBFSolverGLQ10Hist:
    ...
    def sample_by_target_matching(self, target, hist, steps, skip_type='logSNR', order=3, log_scale_min=-6.0, log_scale_max=6.0, log_scale_num=100, exp_num=0):
        # hist : (b, l, c, h, w)
        # target : (b, c, h, w)
